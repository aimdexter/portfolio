    ...
    <>
      <div className='flex flex-col justify-center items-center pt-8 dark:text-white transition duration-500'>
        <div className='pt-4 pb-4 rounded-xl w-[320px]'>
          <h1 className='text-2xl font-semibold text-gray-900 text-center dark:text-white transition duration-500'>
            I’m ready to talk...
          </h1>
          <form
            className='mt-12'
          ...
          >
            ...
            <div className='relative'>
              <input
                ...
                name='Name'
                type='text'
                className='bg-transparent pl-2 peer h-10 w-full border-2 border-gray-300 dark:text-white text-gray-900 placeholder-transparent focus:outline-none focus:border-brand'
                placeholder='Name'
              />
              <label
                htmlFor='Name'
            ...
            <div className='mt-10 relative'>
              <input
                ...
                type='text'
                name='email'
                className='bg-transparent peer pl-2 h-10 w-full border-2 border-gray-300 dark:text-white text-gray-900 placeholder-transparent focus:outline-none focus:border-brand'
                placeholder='email'
              />
              <label
                htmlFor='email'
            ...
            <div className='mt-10 relative'>
              <textarea
                ...
                type='message'
                name='message'
                className='bg-transparent peer pl-2 pt-2 w-full border-2 dark:text-white border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-brand'
                placeholder='Message'
              />
              <label
                htmlFor='Message'
