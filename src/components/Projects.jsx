    ...
    const projects = [
        {
            ...
            content: 'I2i is a company that blend design, engineering, and analytics expertise',
        ...
        },
        {
            ...
            tools: ["HTML", "Css", "Javascript", "Tailwind", "Reactjs", "Vercel", "Github"],
        },
        {
            id: 3,
            title: 'SPACE TRAVEL',
            content: 'Presentation of space travel crew, destination and technologies',
            image: '/images/space.png',
            code: 'https://github.com/aimdexter/Space-Travel',
            demo: 'https://aimdexter.github.io/Space-Travel/index.html',
            tools: ["Html", "Tailwind", "Css", "Javascript", "Github", "Github Pages"],
        },
        {
            id: 4,
            title: 'HUMAN ART',
            ...
            tools: ["Html", "Css", "Javascript", "Tailwind", "Vercel", "Github", "Github Pages"],
        },
        {
            id: 5,
            title: 'Clipboard',
        ...
        },
        {
            id: 6,
            title: 'Huddle',
            content: 'Huddle landing page with curved sections challenge on Frontend Mentor',
    ...
    return (
        <div className="lg:pt-8">
            <div className="lg:flex lg:items-center lg:justify-between">
                ...
                <a href="https://github.com/aimdexter" className='flex bg-dark dark:bg-white transition duration-500 dark:text-dark lg:mt-8  mt-2 p-2 rounded-full text-white items-center gap-2 w-fit' target="_blank">
